...
**Status:** Payment provider port and Mobbex adapter implemented (BILLING-001). Checkout and transaction records implemented (BILLING-002). Payment webhooks implemented (BILLING-003). Refunds are planned.
